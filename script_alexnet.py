...
caffe_root = '/home/nithin/deep-learning/caffe/'
...
def main(argv):
    ...
    try:
        ...
        print 'script_alexnet.py -i <inputfile> -o <outputfile>'
        sys.exit(2)
    ...
    with open(inputfile, 'r') as reader:
        with open(outputfile, 'w') as writer:
            ...
            for image_path in reader:
                ...
                writer.seek(-2, os.SEEK_END)
                writer.truncate()
                writer.write('\n')
               # np.savetxt(writer, "88888888888".reshape(1,-1))    
